...
activities = {
    ...
    "Math Club": {
        "description": "Problem solving, competitions, and recreational math",
        "schedule": "Thursdays, 3:30 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Team-based science challenges and experiments",
        "schedule": "Saturdays (biweekly), 9:00 AM - 12:00 PM",
        "max_participants": 16,
